...
function Skill(props) {
    return (
        <div className="shadow-sm shadow-[#040c16] p-4 hover:scale-110 duration-500" data-aos={props.aos} data-aos-duration={props.duration} data-aos-delay={props.delay}>
            <img className="w-20 mx-auto" src={props.src} alt={`${props.name} icon`}/>
    ...
    return (
        <div name="skills" className="w-full h-screen bg-[#0a192f] text-gray-300">
            ...
            <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full" >
                <div>
                    <p className="text-4xl font-bold inline border-b-4 border-[#f44b3a]" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">Skills</p>
