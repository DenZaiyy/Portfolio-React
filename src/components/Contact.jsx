    ...
    return (
        <section name='contact' className={`w-full h-screen bg-[#0a192f] flex justify-center items-center p-4`}>
            <form method="POST" action="https://getform.io/f/3d8a28bc-7102-466a-a3ca-f2b681341551" className={`flex flex-col max-w-[600px] w-full`}>
                ...
                <button type="submit" className={`text-white border-2 hover:bg-[#f44b3a] hover:border-[#f44b3a] px-4 py-3 my-8 mx-auto flex items-center`}>Let's collaborate</button>
            </form>
        </section>
    );
};
